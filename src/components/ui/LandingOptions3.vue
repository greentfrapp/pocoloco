<template>
  <v-card
    ...
    <!-- <p id="options" class="text-card-title-2 text-center text-body-1 font-weight-medium mt-2 mb-4" style="cursor: pointer;" @click="options = !options">
      OPTIONS
      <v-icon class="arrow" color="#818181">{{ arrow }}</v-icon>
    </p> -->
    <v-row justify="center" class="pa-1 flex-nowrap flex-column">      
      <slot></slot>
    </v-row>    
  </v-card>
</template>
